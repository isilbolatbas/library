...
public class Elektrik extends Kutuphane {
	
	public int elektrikSure = 8;
	public int elektrikKat = 4;
	List<String> kitap = new ArrayList<String>();

	@Override
	public void kitapIcerik() {
		// TODO Auto-generated method stub
		System.out.println("kitap teknik kitaptir"+ elektrikKat + ". kattadir");
	...
	public void kitapDonusu() {
		...
		System.out.println(day + elektrikSure + "/" + month + "/" + year+ " tarihinde teslim etmelisiniz.");
	}
