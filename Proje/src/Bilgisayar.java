...
public class Bilgisayar extends Kutuphane {

	public int bilgisayarSure = 7;
	public int bilgisayarKat = 4;
	List<String> kitap = new ArrayList<String>();

	@Override
	public void kitapIcerik() {
		// TODO Auto-generated method stub
		System.out.println("kitap teknik kitaptir"+ bilgisayarKat + ". kattadir");
	...
	public void sureOgren() {
		...
		System.out.println("KITABI 7 GUN ICINDE TESLIM ETMELISINIZ.");
	...
	public void kitapDonusu() {
		...
		System.out.println(day + bilgisayarSure + "/" + month + "/" + year+ " tarihinde teslim etmelisiniz.");
