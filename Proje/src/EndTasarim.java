...
public class EndTasarim extends Kutuphane{
	public int endTasarimSure = 5;
	public int endTasarimKat = 3;
	...
	public void kitapIcerik() {
		...
		System.out.println("kitap teknik kitaptir"+endTasarimKat + ". kattadir");
	...
	public void kitapDonusu() {
		...
		System.out.println(day + endTasarimSure + "/" + month + "/" + year+ " tarihinde teslim etmelisiniz.");
